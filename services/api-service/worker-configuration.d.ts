/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv --env stage` (hash: 5e220cec2ec0fcb8fc3d60a697f5f7b2)
// Runtime types generated with workerd@1.20260526.1 2025-06-17 nodejs_compat
interface __BaseEnv_BaseEnv {
	OPEN_PETS_STORAGE: R2Bucket;
	DB: D1Database;
	TRUSTED_ORIGINS: "https://user-application-stage.workers.dev,https://shelter-application-stage.workers.dev,https://admin-application-stage.workers.dev";
	LOG_LEVEL: "debug";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRUSTED_ORIGINS" | "LOG_LEVEL">> {}
}
